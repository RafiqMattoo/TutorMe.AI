...
> = {
  SuperAdmin: {
    ...
    allowedRoutes: ['/dashboard', '/today', '/deliveries', '/schools', '/approvals', '/users', '/roles', '/enrollments', '/academics', '/students', '/transport', '/articles', '/categories', '/materials', '/tutor', '/simple-bot', '/flashcards', '/quizzes', '/recite', '/explain', '/scenes', '/lesson-plans' , '/audio-recap' ,'/video', '/video/:id','/create-video'],
  },
  SchoolAdmin: {
    label: "School Admin",
