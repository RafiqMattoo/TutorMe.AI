...
export const roleProfiles: Record<UserRole, {
  ...
  SuperAdmin: {
    ...
    allowedRoutes: ['/dashboard', '/today', '/deliveries', '/schools', '/approvals', '/users', '/roles', '/enrollments', '/academics', '/students', '/transport', '/articles', '/categories', '/materials', '/tutor', '/simple-bot', '/flashcards', '/quizzes', '/recite', '/explain', '/scenes', '/lesson-plans' , '/audio' ,'/video' , '/create-video'],
  },
  SchoolAdmin: {
    label: 'School Admin',
    ...
    allowedRoutes: ['/dashboard', '/today', '/deliveries', '/approvals', '/users', '/roles', '/enrollments', '/academics', '/students', '/transport', '/articles', '/categories', '/materials', '/tutor', '/simple-bot', '/flashcards', '/quizzes', '/recite', '/explain', '/scenes', '/lesson-plans'],
  },
  Teacher: {
    label: 'Teacher',
    ...
    allowedRoutes: ['/dashboard', '/today', '/deliveries', '/students', '/articles', '/categories', '/materials', '/tutor', '/simple-bot', '/flashcards', '/quizzes', '/recite', '/explain', '/scenes', '/lesson-plans'],
  },
  Student: {
    label: 'Student',
    ...
    allowedRoutes: ['/dashboard', '/today', '/articles', '/categories', '/materials', '/tutor', '/simple-bot', '/flashcards', '/quizzes', '/recite', '/explain', '/scenes'],
  },
  Parent: {
    label: 'Parent',
