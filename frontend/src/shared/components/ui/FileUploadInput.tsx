...
export default function FileUploadInput({
  ...
  const handleValueChange = (nextValue: FileUploadValue | null, fieldChange?: (value: FileUploadValue | null) => void) => {
  ...
  const handleFileSelection = (
    file: File | null,
    fieldChange?: (value: FileUploadValue | null) => void,
  ) => {
    if (!file) return
  ...
  const clearSelection = (fieldChange?: (value: FileUploadValue | null) => void) => {
