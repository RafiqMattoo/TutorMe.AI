...
export default function AdminLayout() {
  ...
  // same pattern used by SearchableDropdown for consistency.
  useEffect(() => {
    if (!notifOpen) return;
        ...
        >
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <div className="relative" ref={notifRef}>
              ...
              {notifOpen && (
                <div className="absolute right-0 z-40 mt-2 w-80 origin-top-right overflow-hidden rounded-xl border border-slate-200 bg-white shadow-xl animate-fade-in">
                  <div className="flex items-center justify-between border-b border-slate-100 px-4 py-2.5">
                    <span className="text-[13px] font-bold text-slate-900">
                      Notifications
                    </span>
