  ...
  return (
    <div className="h-screen bg-white text-slate-900">
      <div className="grid h-full lg:grid-cols-[0.85fr_1.15fr]">
        {/* Left Panel */}
        <section
          className="sticky top-0 hidden h-screen flex-col overflow-hidden px-10 py-10 text-white lg:flex"
          style={{
            background:
              "radial-gradient(circle at 20% 15%, rgba(37,99,235,0.45) 0%, transparent 45%), radial-gradient(circle at 90% 90%, rgba(99,102,241,0.35) 0%, transparent 40%), linear-gradient(160deg, #020617 0%, #0c1a3a 55%, #080f1e 100%)",
          }}
        >
          <div
          ...
          {/* Hero */}
          <div className="relative mt-8 max-w-md flex-1">
          ...
          {/* Footer */}
          <div className="relative mt-auto text-[12px] text-white/40">
        ...
        {/* Right Panel */}
        <section className="h-screen overflow-y-auto px-5 py-8 sm:px-10">
                  ...
                  {tab === "school" ? (
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        {(["Student", "Teacher"] as MemberRole[]).map(
                          (role) => (
                            <button
                              key={role}
