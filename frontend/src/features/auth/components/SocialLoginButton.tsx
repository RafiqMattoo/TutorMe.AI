...
function GoogleIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24">
      ...
      <path
        fill="#34A853"
        d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.99.66-2.25 1.06-3.71 1.06-2.86 0-5.28-1.93-6.15-4.53H2.18v2.85A11 11 0 0 0 12 23z"
      />
      <path
        fill="#FBBC05"
        d="M5.85 14.1a6.6 6.6 0 0 1 0-4.2V7.05H2.18a11 11 0 0 0 0 9.9z"
      />
      <path
        fill="#EA4335"
        d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1a11 11 0 0 0-9.82 6.05l3.67 2.85C6.72 7.3 9.14 5.38 12 5.38z"
      />
    </svg>
  )
}
      ...
      <div className="grid w-full grid-cols-2 gap-3">
        {providers.map(({ name, icon: Icon }) => (
          <button
            ...
            className="flex h-12 w-full items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-4 text-sm font-semibold text-slate-700 transition-all duration-200 hover:border-slate-300 hover:bg-slate-50"
          >
            <Icon />
            <span>{name}</span>
          </button>
